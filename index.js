    ...
    var ContextProvider = (function(_Component) {
        ...
        function ContextProvider() {
            ...
            return _possibleConstructorReturn(
                this,
                (ContextProvider.__proto__ || Object.getPrototypeOf(ContextProvider)).apply(
                    this,
                    arguments
                )
            );
    ...
    function Divicon() {
        ...
        return (
            (_ret = ((_temp = ((_this2 = _possibleConstructorReturn(
                this,
                (_ref = Divicon.__proto__ || Object.getPrototypeOf(Divicon)).call.apply(
                    _ref,
                    [this].concat(args)
                )
            )),
            _this2)),
            (_this2.renderComponent = function() {
                var ContextProvider = createContextProvider(
                    _extends({}, _this2.context, _this2.getChildContext())
                );
    ...
    _createClass(Divicon, [
        ...
        },
        {
            ...
            value: function createLeafletElement(newProps) {
                var _map = newProps.map,
                    ...
                    props = _objectWithoutProperties(newProps, [
                        'map',
                        'layerContainer',
                        'position',
                    ]);
        ...
        },
        {
            ...
            value: function componentWillMount() {
                _get(
                    Divicon.prototype.__proto__ || Object.getPrototypeOf(Divicon.prototype),
                    'componentWillMount',
                    this
                ).call(this);
